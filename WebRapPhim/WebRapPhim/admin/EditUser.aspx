<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="EditUser.aspx.cs" Inherits="admin_EditUser" %>
                    ...
                    <form role="form" runat="server">
                        <div class="box-body">
                            <div class="form-group">
                                <label>ID</label>
                                <asp:TextBox ID="txtID" runat="server" type="text" class="form-control" placeholder="Enter id" Enabled="false"/>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <asp:Button ID="btnEditUser" runat="server" Text="Edit User" class="btn btn-primary" OnClick="btnEditUser_Click"/>
                        </div>
                    </form>
                </div>
        </div>
