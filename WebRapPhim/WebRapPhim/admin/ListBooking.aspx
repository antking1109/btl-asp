<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ListBooking.aspx.cs" Inherits="admin_ListBooking" %>
                            ...
                            <div class="col-sm-12">
                                <asp:GridView ID="grvBooking" runat="server" AutoGenerateColumns="false" Width="100%" AllowPaging="true" PageSize="10" OnPageIndexChanging="grvBooking_PageIndexChanging" >
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="movieTitle" HeaderText="Phim Đặt" />
